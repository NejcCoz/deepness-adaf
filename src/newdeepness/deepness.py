...
from newdeepness.common.defines import IS_DEBUG, PLUGIN_NAME
...
from newdeepness.images.get_image_path import get_icon_path
from newdeepness.processing.map_processor.map_processing_result import (MapProcessingResult,
...
from newdeepness.processing.models.model_types import ModelDefinition
...
class Deepness:
    ...
    def __init__(self, iface: QgisInterface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Deepness2')

        self.toolbar = self.iface.addToolBar(u'Deepness3')
        self.toolbar.setObjectName(u'Deepness3')
    ...
    def _map_processor_finished(self, result: MapProcessingResult):
        ...
        if isinstance(result, MapProcessingResultFailed):
            ...
            msg = 'Info! Processing canceled by user!'
