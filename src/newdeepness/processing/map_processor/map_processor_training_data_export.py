...
from newdeepness.processing.map_processor.map_processing_result import (MapProcessingResultCanceled,
                                                                        MapProcessingResultSuccess)
from newdeepness.processing.map_processor.map_processor import MapProcessor
